...
declare sub FAT_FORMAT(disk as unsigned integer)
declare function FAT_SELECT(disk as unsigned integer, parametre as byte ptr) as FS_RESSOURCE ptr
...
declare sub FatFS_WriteSectors(disk as unsigned integer,lba as unsigned integer,nbrBlocs as unsigned integer,buffer as unsigned byte ptr)
declare sub FatFS_ReadSectors(disk as unsigned integer,lba as unsigned integer,nbrBlocs as unsigned integer,buffer as unsigned byte ptr)