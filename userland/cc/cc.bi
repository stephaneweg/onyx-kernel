...
#define _CHR                 (  1 shl 2)
#define _SHORT               (BPW shl 2)
#define _INT                 (INTSIZE shl 2)
#define UCHR                ((  1 shl 2) + 1)
#define _USHORT              ((BPW shl 2) + 1)
#define UINT                ((INTSIZE shl 2) + 1)
#define _UNSIGNED             1
...
#define _RETURN   67		'/* restore stack and return */
