...
type FS_DESCRIPTOR FIELD=1
	FS_NAME as byte ptr
    FormatMethod as sub(disk as unsigned integer)
	SelectMethod as function(disk as unsigned integer, parametre as byte ptr)  as FS_RESSOURCE ptr
